    ...
    <>
      ...
      <div className="welcome">
        <p className="descuento">
          Acordate que usando la app, tenés{" "}
          <span className="descuento-span">10% de descuento</span> al pedir un
          turno!
        </p>
      </div>
      <Box>
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              {timeSlots.map((slot, index) => (
                ...
                >
                  {parseInt(slot) >= 13 ? slot + ":00 PM" : slot + ":00 AM"}{" "}
                  {occupiedTimes.has(slot) ? "(Ocupado)" : ""}
                </MenuItem>
              ))}
            </TextField>
            <FormControl fullWidth>
              ...
              <Typography variant="body1">
                Seleccione hasta dos servicios
              </Typography>
            </FormControl>
            <Button
              type="submit"
